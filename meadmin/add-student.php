<?php 
 ...
 if(isset($_POST['std_add_now']))
 {
	 ...
	 if($std_fullname=="" or $std_username=="" or $std_password=="" or $std_grade=="" or $std_gender=="" or $std_roll=="" or $std_id=="" or $std_dob=="" or $std_address=="" or $std_district=="" or $std_father=="" or $std_mother=="" or $std_parent_contact=="")
	 {
	 ...
	 else
	 {
		 ...
		 $add_student_done = $sad->add_student($std_fullname,$std_username,$std_password,$std_grade,$std_roll,$std_id,$std_dob,$std_address,$std_district,$std_gender,$std_father,$std_mother,$std_parent_contact);
			...
			<form method="post">
				...
				<div class="vali-form">
					...
					<div class="col-md-6 form-group1">
						...
						<input type="text" placeholder="Student ID" required="" name="std_id">
					</div>
					<div class="col-md-6 form-group1 form-last">
