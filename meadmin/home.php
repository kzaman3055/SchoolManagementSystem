...
else
{
	...
	$meadmin_username = $sad->meadmin_username($adminname);
	...
	$info = $sad->teacher_info($adminname,$t_staff_type);
	...
	<div class="page-container">
		...
		<div class="sidebar-menu">
			...
			<div class="down">
				...
				<p>System Administrator in HCMHSC</p>
				<ul>
				...
				<ul id="menu">
					...
					<li id="menu-academico"><a href="#"><i class="fa fa-table"></i> <span>Students</span> <span class="fa fa-angle-right" style="float: right"></span></a>
						<ul id="menu-academico-sub">
							<li id="menu-academico-avaliacoes"><a href="home.php?sad=student-information">Students Information</a></li>
							<li id="menu-academico-avaliacoes"><a href="home.php?sad=student-edit">Edit Student</a></li>
							<li id="menu-academico-boletim"><a href="home.php?sad=add-student">Add Students</a></li>
							<li id="menu-academico-avaliacoes"><a href="home.php?sad=student-delete">Delete student</a></li>
					...
					<ul id="menu-academico-sub">
							<li id="menu-academico-avaliacoes"><a href="home.php?sad=teacher-information">Teacher Information</a></li>
							<li id="menu-academico-avaliacoes"><a href="home.php?sad=teacher-edit">Edit Teacher</a></li>
							<li id="menu-academico-boletim"><a href="home.php?sad=teacher-add">Add Teacher</a></li>
							<li id="menu-academico-avaliacoes"><a href="home.php?sad=teacher-delete">Delete Teacher</a></li>
