...
$admin_username = mysqli_real_escape_string($sad->hackme(),$_POST['admin_username']);
$admin_password = mysqli_real_escape_string($sad->hackme(),$_POST['admin_password']);
...
{
$melogin = $sad->meadmin_check($admin_username,$admin_password);
if($melogin==1)
{
