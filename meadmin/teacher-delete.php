	...
	<div class="graph-visual tables-main">
		<h2 class="inner-tittle">
			...
			<div class="tables">
				...
				<table class="table table-bordered ">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<?php echo $teacher_info_admin['t_password']; ?>
							</td>
							<td>
				...
				<a href="home.php?sad=teacher-del&teacherid=<?php echo $teacher_info_admin['t_id']; ?>" class="btn red">Delete</a>
					</td>
						</tr>
						<?php $t_sn++; } ?>
					</tbody>
